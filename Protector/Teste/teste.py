...
def pegarPluviometriaMETOS():
    ...
    path = '/data/' + request.form['idEstacao'] + '/5/last/7d';
...
def pegarDadoEstacaoMETOS():
    ...
    msg_Estacao = ('GET' + path_Estacao + dateStamp + publicKey).encode(encoding='utf-8');
    h_Estacao = HMAC.new(privateKey.encode(encoding='utf-8'), msg_Estacao, SHA256);
